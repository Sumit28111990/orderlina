                ...
                <div className={styles['content-wraps']}>
                    ...
                    >
                        <SwiperSlide className={styles['my-swipers']} >
                            ...
                            <h3 className={styles['slide-title']}><a className={styles['slide-h']} href="" rel="bookmark">Top 9 Restaurant Branding Ideas to Grow Customer Loyalty and Revenues</a></h3>
